...
export interface ObsidianKinopoiskPluginSettings {
  ...
  export class ObsidianKinopoiskSettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        apiKeyDesc.createDiv({ text: 'You need to get API token to use this plugin. Choose free plan and follow steps.' });
        ...
        createHeader(containerEl, 'Movie Settings');
        // Movie file name
        new Setting(containerEl)
        ...
        movieTemplateFileDesc.createDiv({ text: 'Files will be available as templates.' });
        ...
        createHeader(containerEl, 'TV series Settings');
        ...
        seriesTemplateFileDesc.createDiv({ text: 'Files will be available as templates.' });
